...
// if someone is actually reading this, sorry that it's such a mess, I'm just too lazy to clean it up
...
// https://www.geeksforgeeks.org/program-to-convert-given-binary-to-its-equivalent-ascii-character-string/
